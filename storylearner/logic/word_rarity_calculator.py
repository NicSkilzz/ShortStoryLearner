...
def create_word_rarity_ranking(total_word_list_with_duplicates: list):
    ...
    word_rarity_ranking_df = word_rarity_df.sort_values('word_percentage', ascending=False, ignore_index=True)
...
if __name__ == '__main__':
    ...
    word_rarity_ranking = create_word_rarity_ranking(total_word_list_with_duplicates)
